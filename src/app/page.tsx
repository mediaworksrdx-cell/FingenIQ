          ...
          <section className="hero" id="hero">
            ...
            <div className="container relative">
              <div className="hero__content animate-fadeUp aura-halo-emerald" style={{ maxWidth: '960px' }}>
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.82rem', fontWeight: 800, letterSpacing: '0.14em', color: '#2563EB', textTransform: 'uppercase', marginBottom: 'var(--sp-4)' }}>
                  <span style={{ width: '28px', height: '2px', background: 'linear-gradient(90deg, transparent, #2563EB)' }} />
                  <span>CONTINUOUS LEARNING. LIMITLESS GROWTH.</span>
                  <span style={{ width: '28px', height: '2px', background: 'linear-gradient(90deg, #2563EB, transparent)' }} />
                </div>
